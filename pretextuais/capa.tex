...
\titulo{\uppercase{Comparação de Estruturas de Aceleração BVH em Simulações de Tempo Real.}}
\autor{\uppercase{Paulo Sérgio Pierdoná}}
\local{Videira}
\data{2026}
\orientador[Orientador:]{Fábio Jose Rodrigues Pinheiro}
