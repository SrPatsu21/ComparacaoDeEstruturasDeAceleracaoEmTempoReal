...
O Nsight Compute permite extrair informacoes ao nivel de driver, fornecendo métricas para análise de desempenho de kernels CUDA.
...
% warp divergence
\item \textbf{Amostragem de PM: Estados de Warp (\textit{PmSampling WarpStates})}: Visao temeporal do estados de warp durante a duração da carga de trabalho. As métricas em diferentes grupos provêm de diferentes passagens. Traz melhor compreencao do estado de cada warp
