...
O algoritmo de Morton envolve múltiplas etapas de processamento dependentes entre si e requer grandes buffers temporários e é uma ordem de magnitude mais lento do que, por exemplo, ordenar os códigos de Morton. Posteriormente, o método foi aprimorado por Pantaleoni e Luebke e posteriormente por Garanzha que geraram a hierarquia sequencialmente a partir da raiz, processando cada nível em paralelo \cite{apetrei2014fast}.
