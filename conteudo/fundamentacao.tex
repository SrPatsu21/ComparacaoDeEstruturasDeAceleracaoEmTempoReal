...
O \textit{Nsight Compute} permite extrair informações em nível de driver da GPU, disponibilizando métricas detalhadas para análise de desempenho de kernels CUDA.
