...
\begin{figure}[H]
    ...
    \caption{Diagram demonstrando como Nsight Compute consegue coletar metricas ao inserir bibliotecas de metricas entre o processo e os \textit{drivers}. Fonte: \cite{nvidia_nsight_compute}}
    \label{fig:nvidia_nsight_}
\end{figure}
...
% Nvlink para multigpu n temos :)
% Nvlink_Tables mesma coisa
% Nvlink_Topology ja sabe
...
Amostragem de PM: Estados de Warp (PmSampling_WarpStates): Estados de warp amostrados periodicamente durante a duração da carga de trabalho. As métricas em diferentes grupos provêm de diferentes passagens.
...
maybe
https://docs.nvidia.com/cuda/archive/11.4.3/profiler-users-guide/index.html
...
https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html?highlight=sm__maximum_warps_per_active_cycle_pct#occupancy-metrics
...
https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html?highlight=sm__maximum_warps_per_active_cycle_pct#device-memory
