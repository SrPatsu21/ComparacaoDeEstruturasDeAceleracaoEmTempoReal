...
% verificar se pode ser escrito dessa forma
...
O pipeline do PICA PICA se inicia com o \textit{object-space rendering}(renderização no espaço de objetos), trata a estruturas geométricas e coordenadas de textura. Faz o calculo de transparencia e translucides para raios. Depois com \textit{global illumination} calcula oclusão (esse processo é limitada para um numero maximo de testes por quadro) \cite{barre2019hybrid}. G-buffer \cite{}.
