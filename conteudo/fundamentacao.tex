...
A travessia do raio começa então no nó raiz e, se um raio não encontrar um \gls{bv} nesta hierarquia, a subárvore inteira pode ser ignorada. Comparadas a outras abordagens, as \glspl{bvh}  geralmente têm os menores requisitos de memória e um memory footprint pré-computável \cite{bauszat2010minimal}.

Técnicas híbridas têm sido investigadas minuciosamente nos últimos anos, buscando combinar os benefícios das árvores kd e das BVHs.
